                    ...
                    <div class="card-body">
                       <form @submit.prevent="store()">
                           ...
                           <div class="mb-3">
                               ...
                               <input type="text" class="form-control" placeholder="yyyy-mm-dd hh:mm:ss" v-model="edit.instagram">
...
export default {
     setup () {
        ...
        onMounted(() => {
            axios.get('http://127.0.0.1:8000/api/kontak/${route.params.id}')
            .then((result) => {
                kontak.no_tlp = result.data.data.no_tlp
                kontak.email = result.data.data.email
                kontak.instagram = result.data.data.instagram
            }).catch((err) => {
